...
Elements are always infallible — diagnostics are expressed via `error!`, `warn!`, `note!`, `help!`, and `bail!` macros generated by `#[element]`, available inside element function bodies.
