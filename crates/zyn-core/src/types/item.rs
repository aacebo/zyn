...
impl<'i> FromInput<'i> for syn::Item {
...
impl<'i> FromInput<'i> for syn::ItemStruct {
    fn from_input(input: &'i Input) -> crate::Result<Self> {
        match input {
...
impl<'i> FromInput<'i> for syn::ItemEnum {
    fn from_input(input: &'i Input) -> crate::Result<Self> {
        match input {
...
impl<'i> FromInput<'i> for syn::ItemUnion {
    fn from_input(input: &'i Input) -> crate::Result<Self> {
        match input {
